...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Persistence)(nil), (*equinixmetal.Persistence)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Persistence_To_equinixmetal_Persistence(a.(*Persistence), b.(*equinixmetal.Persistence), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*equinixmetal.Persistence)(nil), (*Persistence)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_equinixmetal_Persistence_To_v1alpha1_Persistence(a.(*equinixmetal.Persistence), b.(*Persistence), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControlPlaneConfig_To_equinixmetal_ControlPlaneConfig(in *ControlPlaneConfig, out *equinixmetal.ControlPlaneConfig, s conversion.Scope) error {
	out.Persistence = (*equinixmetal.Persistence)(unsafe.Pointer(in.Persistence))
	return nil
}
...
func autoConvert_equinixmetal_ControlPlaneConfig_To_v1alpha1_ControlPlaneConfig(in *equinixmetal.ControlPlaneConfig, out *ControlPlaneConfig, s conversion.Scope) error {
	out.Persistence = (*Persistence)(unsafe.Pointer(in.Persistence))
	return nil
}
...
// Convert_v1alpha1_Persistence_To_equinixmetal_Persistence is an autogenerated conversion function.
func Convert_v1alpha1_Persistence_To_equinixmetal_Persistence(in *Persistence, out *equinixmetal.Persistence, s conversion.Scope) error {
	return autoConvert_v1alpha1_Persistence_To_equinixmetal_Persistence(in, out, s)
}
...
// Convert_equinixmetal_Persistence_To_v1alpha1_Persistence is an autogenerated conversion function.
func Convert_equinixmetal_Persistence_To_v1alpha1_Persistence(in *equinixmetal.Persistence, out *Persistence, s conversion.Scope) error {
	return autoConvert_equinixmetal_Persistence_To_v1alpha1_Persistence(in, out, s)
}
