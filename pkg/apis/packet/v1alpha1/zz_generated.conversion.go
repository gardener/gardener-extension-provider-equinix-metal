...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Persistence)(nil), (*packet.Persistence)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Persistence_To_packet_Persistence(a.(*Persistence), b.(*packet.Persistence), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*packet.Persistence)(nil), (*Persistence)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_packet_Persistence_To_v1alpha1_Persistence(a.(*packet.Persistence), b.(*Persistence), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ControlPlaneConfig_To_packet_ControlPlaneConfig(in *ControlPlaneConfig, out *packet.ControlPlaneConfig, s conversion.Scope) error {
	if in.Persistence != nil {
		...
		*out = new(packet.Persistence)
		if err := Convert_v1alpha1_Persistence_To_packet_Persistence(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Persistence = nil
...
func autoConvert_packet_ControlPlaneConfig_To_v1alpha1_ControlPlaneConfig(in *packet.ControlPlaneConfig, out *ControlPlaneConfig, s conversion.Scope) error {
	if in.Persistence != nil {
		in, out := &in.Persistence, &out.Persistence
		*out = new(Persistence)
		if err := Convert_packet_Persistence_To_v1alpha1_Persistence(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.Persistence = nil
...
func autoConvert_v1alpha1_Persistence_To_packet_Persistence(in *Persistence, out *packet.Persistence, s conversion.Scope) error {
...
// Convert_v1alpha1_Persistence_To_packet_Persistence is an autogenerated conversion function.
func Convert_v1alpha1_Persistence_To_packet_Persistence(in *Persistence, out *packet.Persistence, s conversion.Scope) error {
	return autoConvert_v1alpha1_Persistence_To_packet_Persistence(in, out, s)
}

func autoConvert_packet_Persistence_To_v1alpha1_Persistence(in *packet.Persistence, out *Persistence, s conversion.Scope) error {
...
// Convert_packet_Persistence_To_v1alpha1_Persistence is an autogenerated conversion function.
func Convert_packet_Persistence_To_v1alpha1_Persistence(in *packet.Persistence, out *Persistence, s conversion.Scope) error {
	return autoConvert_packet_Persistence_To_v1alpha1_Persistence(in, out, s)
}
